...
<?php
	...
	$pol = mysqli_connect("127.0.0.1","root","","dzik");
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ["Natężenie światła", "Ciśnienie", "Wysokość", "Temperatura z czujnika ciśnienia", "Temperatura z czujnika wilgotności", "Wilgotność"],
        datasets: [{
            label: 'Wartość zczytanych pomiarów',
            data: [20, 19, 3, 5, 2, 3],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
