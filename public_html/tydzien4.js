...
$(document).ready(function(){
	$.ajax({
		url: "http://student.agh.edu.pl/~pzwolak/tydzien4.php",
		method: "GET",
		success: function(data) {
			...
			var chartdata = {
				...
				datasets : [
					{
						label: "Wilgotność [RH%]",
						borderColor : 'rgba(55,102,64, 0.7)',
						pointBorderColor : 'rgba(55,102,64, 1)',
						borderWidth : 5,
						//kolor tla i legendy
						fill: true, //czy wypelnic zbior
						backgroundColor : 'rgba(55,102,64, 0.2)', //wplywa tez na kolor w legendzie
						//ustawienia punktu
						pointRadius : 5,
						pointBorderWidth : 3,
