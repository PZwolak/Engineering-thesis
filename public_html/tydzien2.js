...
$(document).ready(function(){
	$.ajax({
		url: "http://student.agh.edu.pl/~pzwolak/tydzien2.php",
		method: "GET",
		success: function(data) {
			...
			var chartdata = {
				...
				datasets : [
					{
						label: "Ciśnienie [hPa]",
						borderColor : 'rgba(75,30,255, 0.7)',
						pointBorderColor : 'rgba(75,30,255, 1)',
						borderWidth : 5,
						//kolor tla i legendy
						fill: true, //czy wypelnic zbior
						backgroundColor : 'rgba(75,30,255, 0.2)', //wplywa tez na kolor w legendzie
						//ustawienia punktu
						pointRadius : 5,
						pointBorderWidth : 3,
